...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "pyim-candidates" '("pyim-candidate")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "pyim-entered" '("pyim-")))
